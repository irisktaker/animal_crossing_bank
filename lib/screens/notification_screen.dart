                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const Padding(
                          ...
                          child: Text(
                            '1). Connect with friends and'
                            '\nsign them up so you both'
                            '\nearn 100 Bells!',
                            style: TextStyle(
                              color: Colors.white,
                              fontSize: 15,
                        ...
                        const Padding(
                          ...
                          child: Text(
                            '2). Don’t have enough?'
                            '\nBorrow from Tom Nook and'
                            '\npay it back by the end of the'
                            '\nmonth to avoid over drafts! ',
                            style: TextStyle(
                              color: Colors.white,
                              fontSize: 15,
                              height: 1.3,
